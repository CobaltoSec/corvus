...
Corvus has been battle-tested against the real-world MCP ecosystem across three case studies — 126 servers audited, spanning official `@modelcontextprotocol` packages, community servers, and the broader npm ecosystem.

| | CS01 | CS02 | CS03 | Combined |
|---|---|---|---|---|
| Servers audited | 20 | 29 | 8 | **126** |
| True positives | 70 | 51 | ~70 | **~856** |
