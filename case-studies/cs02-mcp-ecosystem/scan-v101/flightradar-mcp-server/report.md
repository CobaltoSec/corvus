...
Package '@modelcontextprotocol/sdk' (dependency of 'flightradar-mcp-server') has a known high vulnerability. Solo aplicable a servidores npm vía stdio. HTTP transport: no analizable.
