...
**Target:** `npx -y openapi-mcp-server`
**Transport:** stdio
**Date:** 2026-07-02 17:44:33
**Duration:** 131.0s
...
### CORVUS-001 — Excessive description length in 'getApiOverview'
...
Description is 3523 chars (limit 1000). May contain hidden content.
...
### CORVUS-002 — Excessive description length in 'getApiOperation'
...
Description is 3527 chars (limit 1000). May contain hidden content.
