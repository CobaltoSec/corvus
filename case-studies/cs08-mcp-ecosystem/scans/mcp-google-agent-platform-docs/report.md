...
**Target:** `uvx mcp-google-agent-platform-docs`
**Transport:** stdio
**Date:** 2026-07-05 20:26:25
**Duration:** 23.7s
...
| Field | Value |
|-------|-------|
| Name | google-agent-platform-docs |
| Version | 1.28.1 |
| Protocol | 2024-11-05 |
...
### CORVUS-001 — Injection reflected — 'search_docs.query'
...
**Evidence:**
```
No results found for '' OR '1'='1' in source 'geap'.
```
