...
**Target:** `uvx mcpzoo-file-hash`
**Transport:** stdio
**Date:** 2026-07-05 20:28:42
**Duration:** 33.2s
...
**Evidence:**
```
Server disconnected after batch. Pre-crash response: {"jsonrpc":"2.0","id":37,"result":{"content":[{"type":"text","text":"文件不存在或非普通文件: test"}],"structure
```
