...
**Target:** `uvx mcp-local-image-reader`
**Transport:** stdio
**Date:** 2026-07-05 20:26:30
**Duration:** 10.0s
...
**Evidence:**
```
Server disconnected after batch. Pre-crash response: {"jsonrpc":"2.0","id":36,"result":{"content":[{"type":"text","text":"Error reading image: Not a file
```
