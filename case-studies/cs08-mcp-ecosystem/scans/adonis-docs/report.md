...
**Target:** `uvx adonis-docs-mcp`
**Transport:** stdio
**Date:** 2026-07-05 20:16:43
**Duration:** 45.6s
...
### CORVUS-001 — Injection reflected — 'list_sections.version'
...
**Evidence:**
```
Unknown version '<script>alert(1)</script>'. Available: v7, v6, v5, edge, lucid
```
...
### CORVUS-002 — 'list_sections' accepts undeclared extra fields
