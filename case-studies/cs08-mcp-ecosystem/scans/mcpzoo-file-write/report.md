...
**Target:** `uvx mcpzoo-file-write`
**Transport:** stdio
**Date:** 2026-07-05 20:28:44
**Duration:** 19.1s
...
### CORVUS-001 — Shadow Tool — 'write_file' conflicts with a high-value built-in name
...
### CORVUS-002 — Injection reflected — 'write_file.path'
...
**Evidence:**
```
写入失败: [Errno 13] Permission denied: '../../etc/passwd'
```
