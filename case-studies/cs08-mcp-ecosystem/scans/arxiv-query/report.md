...
**Target:** `uvx arxiv-query-mcp`
**Transport:** stdio
**Date:** 2026-07-05 20:17:10
**Duration:** 54.3s
...
### CORVUS-001 — Excessive description length in 'arxiv_search'
...
Description is 1349 chars (limit 1000). May contain hidden content.
...
### CORVUS-002 — Excessive description length in 'arxiv_list_by_category'

| Field | Value |
|-------|-------|
| Severity | **MEDIUM** |
| OWASP | MCP03 |
| Tool | `arxiv_list_by_category` |
| Parameter | `—` |
| Confidence | 80% |

Description is 1091 chars (limit 1000). May contain hidden content.
