...
**Target:** `uvx mcpzoo-file-size`
**Transport:** stdio
**Date:** 2026-07-05 20:29:13
**Duration:** 47.9s
...
### CORVUS-001 — 'convert_size.size' silently accepts wrong type
...
Expected type 'number', sent int value '0' — no error returned.
...
### CORVUS-002 — 'convert_size' accepts undeclared extra fields
