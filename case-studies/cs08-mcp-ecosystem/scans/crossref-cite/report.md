...
**Target:** `uvx crossref-cite-mcp`
**Transport:** stdio
**Date:** 2026-07-05 20:18:23
**Duration:** 31.5s
...
### CORVUS-001 — Excessive description length in 'resolve_citation'
...
Description is 2080 chars (limit 1000). May contain hidden content.
...
### CORVUS-002 — Parameter 'formats' in 'resolve_citation' has no type constraint
...
**Remediation:** Add an explicit type to parameter 'formats'.

---

### CORVUS-003 — Parameter 'filter_from_year' in 'resolve_citation' has no type constraint
...
**Remediation:** Add an explicit type to parameter 'filter_from_year'.

---

### CORVUS-004 — Parameter 'filter_to_year' in 'resolve_citation' has no type constraint
...
**Remediation:** Add an explicit type to parameter 'filter_to_year'.

---

### CORVUS-005 — Parameter 'filter_type' in 'resolve_citation' has no type constraint
...
### CORVUS-013 — Server accepts requests without jsonrpc field
...
### CORVUS-014 — Server accepts array request ID — JSON-RPC spec violation
