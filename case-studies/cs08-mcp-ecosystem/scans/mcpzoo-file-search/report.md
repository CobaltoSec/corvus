...
**Evidence:**
```
Server disconnected after batch. Pre-crash response: {"jsonrpc":"2.0","id":37,"result":{"content":[{"type":"text","text":"未找到匹配的文件"}],"structuredContent"
```
