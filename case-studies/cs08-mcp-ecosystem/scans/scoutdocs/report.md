...
**Target:** `uvx scoutdocs-mcp`
**Transport:** stdio
**Date:** 2026-07-05 20:31:47
**Duration:** 30.5s
...
### CORVUS-001 — 'detect_project_dependencies' defines no required fields

| Field | Value |
|-------|-------|
| Severity | **INFO** |
| OWASP | EXT02 |
| Tool | `detect_project_dependencies` |
| Parameter | `—` |
| Confidence | 70% |
...
### CORVUS-005 — Protocol crash — JSON-RPC batch array caused server disconnect
...
**Evidence:**
```
Server disconnected after batch. Pre-crash response: {"jsonrpc":"2.0","id":28,"result":{"protocolVersion":"2025-11-25","capabilities":{"experimental":{},
```
