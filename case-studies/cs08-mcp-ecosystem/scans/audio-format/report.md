...
**Target:** `uvx audio-format-mcp`
**Transport:** stdio
**Date:** 2026-07-05 20:16:58
**Duration:** 17.5s
...
**Evidence:**
```
Server disconnected after batch. Pre-crash response: {"jsonrpc":"2.0","id":37,"result":{"content":[{"type":"text","text":"Error executing tool convert_au
```
