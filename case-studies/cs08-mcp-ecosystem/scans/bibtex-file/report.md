...
**Target:** `uvx bibtex-file-mcp`
**Transport:** stdio
**Date:** 2026-07-05 20:17:41
**Duration:** 29.3s
...
### CORVUS-004 — Protocol crash — JSON-RPC batch array caused server disconnect
...
**Evidence:**
```
Server disconnected after batch. Pre-crash response: {"jsonrpc":"2.0","id":45,"result":{"content":[{"type":"text","text":"Error executing tool read_bibte
```
