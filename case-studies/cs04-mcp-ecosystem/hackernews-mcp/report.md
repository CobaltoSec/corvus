...
**Target:** `npx -y hackernews-mcp`
**Transport:** stdio
**Date:** 2026-07-03 16:54:32
**Duration:** 59.7s
...
### CORVUS-001 — 'get_top_hackernews_stories' has no description

| Field | Value |
|-------|-------|
| Severity | **LOW** |
| OWASP | EXT02 |
| Tool | `get_top_hackernews_stories` |
| Parameter | `—` |
| Confidence | 80% |
...
### CORVUS-002 — 'get_top_hackernews_stories' accepts undeclared extra fields
