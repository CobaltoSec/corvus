...
**Target:** `npx -y mcp-hacker-news`
**Transport:** stdio
**Date:** 2026-07-03 16:54:13
**Duration:** 40.4s
...
### CORVUS-002 — Protocol crash — oversized method name caused transport failure
...
### CORVUS-003 — Protocol crash — deeply nested params caused server disconnect
