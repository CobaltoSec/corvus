...
**Target:** `npx -y faker-mcp-server`
**Transport:** stdio
**Date:** 2026-07-03 17:05:45
**Duration:** 56.0s
...
### CORVUS-001 — Scope Creep — 'generate-person' inputSchema requests PII fields
...
Tool 'generate-person' inputSchema declares field(s) associated with PII: includeDateOfBirth. Collecting PII through MCP tools may violate data minimization principles and privacy regulations.



**Evidence:**
```
inputSchema properties: includeDateOfBirth
```
...
### CORVUS-002 — Supply Chain — '@modelcontextprotocol/sdk' has high vulnerability (no CVE assigned)
...
Package '@modelcontextprotocol/sdk' (dependency of 'faker-mcp-server') has a known high vulnerability. Solo aplicable a servidores npm vía stdio. HTTP transport: no analizable.
...
### CORVUS-003 — 'generate-person' defines no required fields
...
### CORVUS-004 — 'generate-company' defines no required fields

| Field | Value |
|-------|-------|
| Severity | **INFO** |
| OWASP | EXT02 |
| Tool | `generate-company` |
| Parameter | `—` |
| Confidence | 70% |
...
### CORVUS-005 — 'generate-person' accepts undeclared extra fields
...
### CORVUS-006 — 'generate-company' accepts undeclared extra fields
