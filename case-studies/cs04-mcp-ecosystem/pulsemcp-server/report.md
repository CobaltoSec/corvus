...
**Target:** `npx -y pulsemcp-server`
**Transport:** stdio
**Date:** 2026-07-03 16:55:37
**Duration:** 62.7s
...
Package '@modelcontextprotocol/sdk' (dependency of 'pulsemcp-server') has a known high vulnerability. Solo aplicable a servidores npm vía stdio. HTTP transport: no analizable.
...
The server accepted initialize with arbitrary protocol versions: ['2030-01-01', '1.0', '2024-01-01', '""', '0.1']. The server also accepted far-future versions, indicating no version validation at all. Servers should reject versions outside their supported range to prevent feature-downgrade attacks.



**Evidence:**
```
Accepted versions: ['2030-01-01', '1.0', '2024-01-01', '""', '0.1']
```
